...
export const articles = [
  ...
  },
  {
    ...
    title: "GTA 6: Community Speculation vs Official Reality — The May 21 Verdict",
    excerpt: "Three weeks of community speculation crashed into an official confirmation: GTA 6 launches November 19, 2026, locked in.",
    status: STATUS.VERIFIED,
    ...
    breaking: true,
    body: [
      "May 21, 2026 became the day of reckoning. Three weeks of community speculation crashed directly into an official, immovable confirmation: Grand Theft Auto VI launches November 19, 2026. Locked in.",
      "The r/GTA6 community spent weeks waiting for Trailer 3. Threads multiplied, every frame of Rockstar's promotional material was dissected frame-by-frame. The verdict? No official announcement. Rockstar Newswire remained silent.",
      "A Best Buy leak had circulated for days: allegedly 'accidentally published' affiliate emails claiming pre-orders would open May 18. Tom Henderson of Insider Gaming was right: the emails were fake. No official pre-orders launched.",
      "Take-Two Earnings Call (May 21, 2:30 PM PT): Strauss Zelnick, CEO of Take-Two Interactive, publicly and unambiguously reconfirmed: 'Grand Theft Auto VI – Release Date: November 19, 2026'. This isn't news. This is a lock-in. No delay announced, no regional variation, no product surprises.",
      "Rumor: Trailer 3 imminent (FALSE). Rumor: May 18 pre-orders confirmed (DEBUNKED). Rumor: Surprise announcements at earnings call (FALSE). Reality: November 19 release confirmed by CEO (TRUE).",
      "The 'Best Buy leaks' and 'internal email' screenshots floating around? Always verify your sources. If it's not signed by Rockstar or Take-Two, treat it as rumor until official proof surfaces. The only solid news that day didn't come from forums — it came from the CEO on an earnings call.",
    ],
    sources: [
      { label: "Take-Two Q1 2027 Earnings Call Transcript (May 21, 2026)", url: "#" },
      { label: "Rockstar Games Official — GTA 6 Site", url: "https://www.rockstargames.com/gta6" },
