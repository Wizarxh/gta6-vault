...
export const articles = [
  {
    ...
    excerpt: "Leaked Best Buy affiliate email confirms GTA 6 pre-orders opening tomorrow. Trailer 3 likely drops before pre-orders go live.",
    status: STATUS.RUMOR,
    category: "Breaking",
    date: "2026-05-17",
    author: "Signal",
    readingTime: 5,
    hero: "https://d8j0ntlcm91z4.cloudfront.net/placeholder-gta6-preorder.jpg",
    breaking: true,
    body: [
